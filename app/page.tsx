    ...
    <>
      ...
      <main>
        <Hero />
          {/* 
            Section Heading
            - mb-12: margin below heading for spacing
            - sr-only: visually hidden but available for screen readers (accessibility)
          */}
          ...
          - pb-20: extra padding at bottom before footer
        */}
        ...
        <BentoCard
          ...
          href="/development"
            ...
            {featuredAdventure && (
              ...
              >
                <BentoCard
                  ...
                  href="/adventures"
                >
                  {/* Location and date in a flex container */}
            ...
            {/* 
              CARD 5: CV Downloads
              - Provides download links for both CVs
              - Not clickable as a whole card (no href prop)
              - Children contain the actual download links
